...
class FrozenLakeEnv(Env):
    ...
    probability of 3/4 else will move in either perpendicular direction with
    equal probability of 1/8 in both directions.
                    ...
                    if letter in b"GH":
                        ...
                        if is_slippery:
                            for b in [(a - 1) % 4, a, (a + 1) % 4]:
                                p=self.act_prob if b==a else self.act_prob/ 2.0
                                li.append(
